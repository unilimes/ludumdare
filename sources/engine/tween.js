...
if (!window.performance || !window.performance.now) {
    let offset = window.performance.timing && window.performance.timing.navigationStart ? window.performance.timing.navigationStart : Date.now();
...
export function Tween(object) {
    ...
    this.update = function (time) {
        ...
        if (_onUpdateCallback !== null) {
            _onUpdateCallback.call(_object, value, _object);
        }
...
Tween.update = (time) =>{
    ...
    for (let i = 0, length = tweens.length; i < length; i++) {
